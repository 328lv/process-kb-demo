...
const modelCases = [
  {
    ...
    sampleFile: "model-samples/shaft-gear-m2-36t.step",
  ...
  },
  {
    ...
    sampleFile: "model-samples/driven-gear-m3-48t.stp",
    previewImage: "assets/gear-model-preview.png",
    partType: "齿轮类零件",
    material: "42CrMo",
    module: 3,
  ...
  },
  {
    ...
    sampleFile: "model-samples/servo-gear-m1-28t.step",
    previewImage: "assets/gear-model-preview.png",
    partType: "小模数齿轮",
    material: "40Cr",
    module: 1,
  ...
  },
  {
    ...
    sampleFile: "model-samples/ring-gear-m5-72t.stp",
    previewImage: "assets/gear-model-preview.png",
    partType: "大型齿圈",
    material: "QT500-7",
    module: 5,
